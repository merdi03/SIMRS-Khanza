 ...
 * @author perpustakaan
 */
public class ElvaDICOM extends javax.swing.JDialog {
    ...
    public ElvaDICOM(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initComponents2();
    }
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        ElvaDICOM.this.setTitle(newValue);
                    });
                });
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ElvaDICOM dialog = new ElvaDICOM(new javax.swing.JFrame(), true);
