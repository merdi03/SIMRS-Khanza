...
public class DlgSetAplikasi extends javax.swing.JDialog {
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement("select nama_instansi, alamat_instansi, kabupaten, propinsi, aktifkan, wallpaper,kontak,email,logo,kode_ppk,kode_ppkinhealth,kode_ppkkemenkes,kunci_tgl_farmasi from setting");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
