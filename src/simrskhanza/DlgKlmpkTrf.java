 ...
 * @author dosen
 */
public final class DlgKlmpkTrf extends javax.swing.JDialog {
    ...
    /** Creates new form DlgKlmpkTrf
     * @param parent
     * @param modal */
    public DlgKlmpkTrf(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kelompok Tarif Perusahaan/Asuransi/Cara Bayar ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Kelompok Tarif Perusahaan/Asuransi/Cara Bayar ]::");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            Valid.textKosong(TKd,"kode kelompok tarif");
        }else if(TNm.getText().trim().equals("")){
            Valid.textKosong(TNm,"nama kelompok tarif");
        }else{
            if(Sequel.menyimpantf("penjab_klmpk_tarif","?,?","Kode Kategori",2,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        for(i=0;i<tbKategori.getRowCount();i++){ 
            if(tbKategori.getValueAt(i,0).toString().equals("true")){
                if(Sequel.meghapustf("penjab_klmpk_tarif","kd_klmpk_trf",tbKategori.getValueAt(i,1).toString())==true){
                    tabMode.removeRow(i);
                    i--;
                }
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            if(Valid.editTabletf(tabMode,"penjab_klmpk_tarif","kd_klmpk_trf","?","kd_klmpk_trf=?,nm_klmpk_trf=?",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgKlmpkTrf dialog = new DlgKlmpkTrf(new javax.swing.JFrame(), true);
    ...
    private void tampil(){
        ...
        try{
            ps=koneksi.prepareStatement(
                "select * from penjab_klmpk_tarif where kd_klmpk_trf like ? "+
                "or nm_klmpk_trf like ? ");
            try {
