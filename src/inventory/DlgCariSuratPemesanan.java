...
public class DlgCariSuratPemesanan extends javax.swing.JDialog {
    ...
    public DlgCariSuratPemesanan(java.awt.Frame parent, boolean modal) {
        ...
        barang.getJenis().addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgCariPemesanan")){
                    if(barang.getJenis().getTable().getSelectedRow()!= -1){                          
                        kdsat.setText(barang.getJenis().getTable().getValueAt(barang.getJenis().getTable().getSelectedRow(),0).toString());                    
                        nmsat.setText(barang.getJenis().getTable().getValueAt(barang.getJenis().getTable().getSelectedRow(),1).toString());                        
                    }                    
                    kdsat.requestFocus();
                }                   
            }
        ...
        barang.getIndustri().addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            ...
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("DlgCariPemesanan")){
                    if(barang.getIndustri().getTable().getSelectedRow()!= -1){                   
                        KdIF.setText(barang.getIndustri().getTable().getValueAt(barang.getIndustri().getTable().getSelectedRow(),0).toString());                    
                        NmIF.setText(barang.getIndustri().getTable().getValueAt(barang.getIndustri().getTable().getSelectedRow(),1).toString());                                        
                    }   
                    KdIF.requestFocus();
                }
            }
        ...
        barang.getIndustri().getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        BtnPrint7.setBounds(200, 80, 100, 30);
...
*/
    ...
    private void btnSatuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSatuanActionPerformed
        akses.setform("DlgCariPemesanan");
        barang.getJenis().emptTeks();
        barang.getJenis().isCek();
        barang.getJenis().setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        barang.getJenis().setLocationRelativeTo(internalFrame1);
        barang.getJenis().setAlwaysOnTop(false);
        barang.getJenis().setVisible(true);
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
  if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
    ...
    private void btnIFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIFActionPerformed
        akses.setform("DlgCariPemesanan");
        barang.getIndustri().emptTeks();
        barang.getIndustri().isCek();
        barang.getIndustri().setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        barang.getIndustri().setLocationRelativeTo(internalFrame1);
        barang.getIndustri().setAlwaysOnTop(false);
        barang.getIndustri().setVisible(true);
    ...
    private void ppDatangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDatangActionPerformed
        if(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim().equals("")){
            ...
            if(Sequel.cariIsi("select status from surat_pemesanan_medis where no_pemesanan=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString()).equals("Sudah Datang")){
                ...
                aplikasi.isCek();
                aplikasi.tampilData(tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString().trim());
    ...
    private void BtnSeek5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSeek5ActionPerformed
        ...
        akses.setform("DlgCariPemesanan");
        pegawai.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        pegawai.setLocationRelativeTo(internalFrame5);
        pegawai.setAlwaysOnTop(false);
        pegawai.setVisible(true);
        KabidKeu.requestFocus();
